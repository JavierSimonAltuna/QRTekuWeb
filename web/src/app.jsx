// PULSO 5.0 · Supervisor de cargas Garvasa
...
const QRTekuApp = () => {
  ...
  return (
    <div style={S.root}>
      ...
      <header style={S.top}>
        <div style={S.brandRow}>
          ...
          <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.15 }}>
            <span style={{ fontSize: 14, fontWeight: 700, color: "#fafaf9", letterSpacing: -0.3 }}>PULSO 5.0</span>
      ...
      {/* Tweaks */}
      <TweaksPanel title="Tweaks · PULSO 5.0">
